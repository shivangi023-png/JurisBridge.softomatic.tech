                 ...
                 <div style="gap: 10px;display: inline-flex;margin: 34px 10px 10px 8px;">
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_todo">
                             <h4>Normal - {{sizeof($task_Normal)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">

                             @foreach($task_Normal as $row)
                             <div class="todoCBox">
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_in_process">
                             <h4>Blocker -{{sizeof($task_Blocker)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_Blocker as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_testing">
                             <h4>Accounts - {{sizeof($task_Accounts)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">

                             @foreach($task_Accounts as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_On_Hold_Payment">
                             <h4>Hearing - {{sizeof($task_Hearing)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_Hearing as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_completed">
                             <h4>RTI - {{sizeof($task_RTI)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_RTI as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_senior_review">
                             <h4>Meeting - {{sizeof($task_Meeting)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_Meeting as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_cancelled">
                             <h4>Money - {{sizeof($task_Money)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_Money as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                     ...
                     <div class="task_div">
                         <div class="todoHead bg_cancelled">
                             <h4>Deed Registration - {{sizeof($task_Deed_Registration)}}</h4>
                             <i class="bx bx-plus-circle"></i>
                         </div>
                         <div class="todoMain">
                             @foreach($task_Deed_Registration as $row)
                             <div class="todoCBox">
                                 <div class="todoCBoxHead">
                                     <h5 class="todo_title">{{$row->task_title}}</h5>
                                     <i class="bx bx-dots-horizontal-rounded todo_title"></i>
                         ...
                         <table id="table-extended-success" class="table table-hover table_config">
                             ...
                             <tbody class="task_body">
                                 ...
                                 <tr>
                                     ...
                                     <td class="project_task" data-project_id="{{$row->project_id}}" data-task_id="{{$row->id}}" data-task_title="{{$row->title}}" data-task_description="{{$row->description}}" data-task_type="{{$row->type}}" data-task_priority="{{$row->priority}}" data-task_assignee="{{$row->assignee}}" data-task_status="{{$row->status}}" data-task_is_milestone="{{$row->is_milestone}}" data-task_start_date="{{($row->start_date != null) ? date('d/m/Y',strtotime($row->start_date)) : '' }}" data-task_end_date="{{($row->end_date != null) ? date('d/m/Y',strtotime($row->end_date)) : '' }}">
                                         @if($row->type != null)
                                         @if( $row->type_name == 'Normal')
                                         <span class="_type type_Normal">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Blocker')
                                         <span class="_type type_blocker">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Accounts')
                                         <span class="_type type_accounts">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Hearing')
                                         <span class="_type type_hearing">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'RTI')
                                         <span class="_type type_rti">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Meeting')
                                         <span class="_type type_meeting">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Money')
                                         <span class="_type type_money">{{$row->type_name}}</span>
                                         @elseif($row->type_name == 'Deed Registration')
                                         <span class="_type type_deed_registration">{{$row->type_name}}</span>
                                         @endif
                                         @endif
                                     </td>
                                     ...
                                     <td class="ignore-click add_subtask_btn" data-project_id="{{$row->project_id}}" data-task_id="{{$row->id}}" data-task_title="{{$row->title}}">
                                         <a href="javascript:void(0);" title="Create SubTask" class="add_subtask_btn ignore-click" data-project_id="{{$row->project_id}}" data-task_id="{{$row->id}}" data-task_title="{{$row->title}}">
                             ...
                             <tbody id="subtask-list-{{$row->id}}" class="collapse">
                                 <tr class="table-light subtask_update_click" data-id="{{$row1->id}}" data-project_id="{{$row1->project_id}}" data-task_id="{{$row1->task_id}}" data-task_title="{{$row1->title}}" data-subtask_file_link="{{$row1->file_link}}" data-title="{{$row1->title}}" data-task_description="{{$row1->description}}" data-type="{{$row1->type}}" data-priority="{{$row1->priority}}" data-assignee="{{$row1->assignee}}" data-status="{{$row1->status}}" data-subtask_is_milestone="{{$row1->is_milestone}}" data-task_start_date="{{($row1->start_date != null) ? date('d/m/Y',strtotime($row1->start_date)) : '' }}" data-task_end_date="{{($row1->end_date != null) ? date('d/m/Y',strtotime($row1->end_date)) : '' }}">
                                     <td colspan="2" class="text-center"> {{$p++}}</td>
                                     <td>{{$row1->title}}</td>
                                     <td>{{$row1->name}}</td>
                                     <td>
                                         @if($row1->type != null)
                                         @if( $row1->type_name == 'Normal')
                                         <span class="_type type_Normal">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Blocker')
                                         <span class="_type type_blocker">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Accounts')
                                         <span class="_type type_accounts">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Hearing')
                                         <span class="_type type_hearing">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'RTI')
                                         <span class="_type type_rti">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Meeting')
                                         <span class="_type type_meeting">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Money')
                                         <span class="_type type_money">{{$row1->type_name}}</span>
                                         @elseif($row1->type_name == 'Deed Registration')
                                         <span class="_type type_deed_registration">{{$row1->type_name}}</span>
                                         @endif
                                         @endif
                                     </td>
                                     <td>{{($row1->start_date != null) ? date('d-M-Y',strtotime($row1->start_date)) : '' }}</td>
                                     <td>{{($row1->end_date != null) ? date('d-M-Y',strtotime($row1->end_date)) : '' }}</td>
                                     <td>{{$row1->duration}}</td>
                                     <td></td>
                                 </tr>
                             </tbody>
