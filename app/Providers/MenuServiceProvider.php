...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $salesMenuJson = file_get_contents(base_path('resources/data/menus/sales-menu.json'));
        ...
        \View::share('menuData', [$verticalMenuData, $horizontalMenuData, $verticalMenuBoxiconsData,$salesMenuData]);
    }
}
