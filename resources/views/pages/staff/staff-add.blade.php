                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" class="form-control staff_name" id="staff_name" name="staff_name" placeholder="Staff Name">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="email" class="form-control emailid" id="emailid" name="emailid" placeholder="Email">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control dob datepicker" id="dob" name="dob" placeholder="DOB" autocomplete="off">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control mobile" id="mobile" name="mobile" placeholder="Mobile">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control qualification" id="qualification" name="qualification" placeholder="Qualification">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control designation" id="designation" name="designation" placeholder="Department">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control date_of_joining datepicker" placeholder="Date Of Joining" id="date_of_joining" name="date_of_joining" autocomplete="off">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control password" placeholder="Password" id="password" name="password">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <textarea class="form-control address" id="address" name="address" autocomplete="off" placeholder="Address"></textarea>
