...
return [
  'custom' => [
    ...
    'navbarBgColor' => 'bg-dark', //Options:bg-white(default for vertical-menu),bg-primary(default horizontal-menu), bg-success,bg-danger,bg-info,bg-warning,bg-dark.(Note:color only visible when you scroll down)
    ...
    'templateTitle' => 'Karyarat', //template Title can be changed, default(Frest)
