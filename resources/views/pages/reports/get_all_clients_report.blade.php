...
<body>
    ...
    <h4 style="text-align:center;">All Clients Report {{$FilterDate}}</h4>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        ...
        <tr>
                ...
                <!-- <td style="text-align:left;width:10%;">{{ $row->latitude }}</td>
                <td style="text-align:left;width:10%;">{{ $row->longitude }}</td>
                <td style="text-align:left;width:10%;">{{ $row->city_name }}</td> -->
