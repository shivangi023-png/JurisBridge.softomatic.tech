...
<body>
    ...
    <h4 style="text-align:center;">Reimbursement Expense Report {{$FilterDate}}</h4>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <th style="background-color:#39498b; color:#fff;text-align:center;width:5%;" scope="col">Ledger</th>
        ...
        <tr>
            ...
            <td style="text-align:left;width:5%;">{{$row->sub_heads}}</td>
