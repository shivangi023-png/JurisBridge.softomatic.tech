                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control client" id="client" multiple="multiple">
                                        ...
                                        <option value={{$item->id}}>
                                            {{$item->case_no}}<small>({{$item->client_name}})</small>
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="data_div">
                        <div class="action-dropdown-btn d-none">
                            <div class="dropdown quotation-filter-action">
                                <button class="btn border dropdown-toggle mr-1" type="button" id="quotation-filter-btn"
                            ...
                            <div class="dropdown quotation-options">
                                <button class="btn border dropdown-toggle mr-2" type="button" id="quotation-options-btn"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Options
                                </button>
                            ...
                            <a href="quotation_add" class="btn btn-icon btn-outline-primary mr-1 add_button"
...
<!--Extra Large Modal -->
<div class="modal fade text-left w-100" id="updatequotation" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel16" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel16">Update Quotation <span class="font-small-3"
                        id="up_client"></span></h4>
                ...
                <form id="up_form">
                            ...
                            <fieldset class="form-group">
                                <div class="input-group">
                                    <input type="text" name="date"
                                        class="form-control date pickadate  mb-50 mb-sm-0 up_send_date"
                                        id="floating-label1" placeholder="Date">
                                </div>
                    ...
                    <div class="row  padding-top">
                        ...
                        <div class="col-md-4">
                            <fieldset class="form-group">
                                <div class="form-label-group">
                                    <input type="text" class="form-control up_no_of_units" id="up_no_of_units"
                        ...
                        <div class="col-md-4">
                            <fieldset class="form-group">
                                <div class="form-label-group">
                                    <input type="text" class="form-control up_per_unit_amount" id="up_per_unit_amount"
                        ...
                        <div class="col-md-4">
                            <fieldset class="form-group">
                                <div class="form-label-group">
                                    <input type="text" class="form-control up_amount" id="up_amount"
                                        placeholder="Amount">
                    ...
                    <div class="row">
                        <div class="col-md-12 link_div">
                            <a href="" id="a_link"><span id="file_label"></span></a><span><i class="bx bxs-pencil"
                                    id="edit_doc"></i></span>
    ...
    $(document).on('click', '.send_mail', function() {
        ...
        if (unit != '') {
            if (unit > 25000000) {
                ...
                arr.push('File size is greater than 25 MB');
            }
        }
        ...
        if (quill_body != '') {
            if (quill_body.length > 256) {
                arr.push('body_editor_err');
                arr.push('Message character length is greater than 256');
            }
        }
