            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="received" aria-labelledby="received-tab" role="tabpanel">
                        ...
                        <!-- <div class="body">
                            <h4><b>Total received payment : <span
                                        class="total_rc_h4">{{number_format($total_received,2)}}</span></b></h4>
                        </div> -->
                    </div>
                    <div class="tab-pane" id="deposited" aria-labelledby="deposited-tab" role="tabpanel">
                        ...
                        <!-- <div class="body">
                            <h4><b>Total deposited payment: <span
                                        class="total_dp_h4">{{number_format($total_deposited,2)}}</span></b></h4>
                        </div> -->
                    </div>
                    @if(session('role_id')==1 || session('role_id')==3)
                    <div class="tab-pane" id="approved" aria-labelledby="approved-tab" role="tabpanel">
                        ...
                        <!-- <div class="body">
                            <h4><b>Total approved payment : <span
                                        class="total_ap_h4">{{number_format($total_approved,2)}}</span></b></h4>
                        </div> -->
                    </div>
                    @endif
                </div>
