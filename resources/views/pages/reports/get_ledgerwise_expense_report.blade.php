...
<body>
    ...
    <h4 style="text-align:center;">Ledgerwise Expense Report {{$FilterDate}}</h4>

    @foreach ($accounting_sub_heads as $shead)
    <?php $i = 1; ?>
    @if (sizeof($shead->expense_list))
    <?php $i = 1; ?>
    <h5 class="text-primary"><strong> Ledger -{{$shead->sub_heads}}</strong></h5>
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        ...
        <tr>
            ...
            <th style="text-align:right;">
                <h4 style="color:#5a8dee;">{{AppHelper::moneyFormatIndia($shead->grand_total)}}</h4>
            </th>
        </tr>
    </table>
    @endif
