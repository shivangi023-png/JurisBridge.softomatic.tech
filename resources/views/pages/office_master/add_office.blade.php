                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Office Name">
                                        <label for="office_name">Office Name</label>
                                        <span class="office_name_err valid_err"></span>
                                    </div>
                                </div>
                                 <div class="col-6">
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="hidden" class="form-control office_id" name="id">
                                    <input type="text" class="form-control office_name" name="name" placeholder="Office Name">
                                    <label for="office_name">Office Name</label>
                                    <span class="office_name_err1 valid_err1"></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#submit', function() {
            ...
            if (office_name == '') {
                arr.push('office_name_err');
                arr.push('Office name required');
            }
    ...
    function get_office_update() {
        $.ajax({
            type: "get",
            url: "get_office_update",
            datatype: "text",
