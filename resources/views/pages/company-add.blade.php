                    ...
                    <form class="form" id="form" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <textarea type="text" class="form-control" id="company_address"
                                            name="company_address" placeholder="Address"></textarea>
                            ...
                            <div class="row main_row">
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control company_branch" id="company_branch"
                                            name="company_branch[]" placeholder="Branch Name">
                            ...
                            <div class="table-responsive">
                                <table class="table company-data-table wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="company_edit-{{$val->id}}"
                                                    class="btn btn-icon rounded-circle glow btn-warning mr-1 mb-1"
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="badge badge-pill badge-light-success">{{$val->tax_applicable}}</span>
                                                @else
                                                <span
                                                    class="badge badge-pill badge-light-danger">{{$val->tax_applicable}}</span>
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="badge badge-pill badge-light-success">{{$val->tds_applicable}}</span>
                                                @else
                                                <span
                                                    class="badge badge-pill badge-light-danger">{{$val->tds_applicable}}</span>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
