                            ...
                            <table class="table client-data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-success" href="#" data-toggle="modal" data-target="#contactModal">View</a></td>
...
<div class="modal fade text-left" id="contactModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true">
...
<script>
    ...
    $(document).on('click', '.filter_btn', function() {
        ...
        if (arr != '') {
            ...
            <<
            << << < Updated upstream
            get_daily_leads_by_sales(staff_id, date); ===
            === = <<
            <<
            <<
            <
            HEAD: resources / views / pages / daily_sales_report.blade.php
            ...
            >>>
            >
            upstream / main: resources / views / pages / clients / daily_sales_report.blade.php >>>
                >>> > Stashed changes
        }
    });
