                    ...
                    <form class="form" id="form">
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" class="form-control client_name" name="client_name"
                                            placeholder="Client Name" name="fname-column">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-label-group">
                                        <input type="number" class="form-control no_of_units" name="no_of_units"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text"
                                            class="form-control pickadate mr-2 mb-50 mb-sm-0 date start_date">
                            ...
                            <div class="row">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <label class="input-group-text"
                                                        for="inputGroupSelect01">Source</label>
                                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" class="form-control mr-2 mb-50 mb-sm-0 latitude"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" class="form-control mr-2 mb-50 mb-sm-0 longitude"
                                            autocomplete="off" placeholder="Longitude">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-label-group">
                                        <textarea class="form-control address" name="address" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-label-group">
                                        <textarea class="form-control client_enquiry" name="client_enquiry"
                                            autocomplete="off" placeholder="Enquiry/Remark"></textarea>
                            ...
                            <div class="contact_div_up">
                                <div class="row">
                                    <div class="col-md-4 col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control name name1" name="name[]" value=""
                                                placeholder="Name">
                                    ...
                                    <div class="col-md-3 col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control email email1" name="email[]" value=""
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control contact contact1" name="contact[]"
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="form-label-group">
                                            <input type="text" class="form-control whatsapp whatsapp1" name="whatsapp[]"
                                    ...
                                    <div class="col-md-1 col-12 ">
                                        <button type="button" class="btn mr-2 btn-light-secondary add_row"><i
                            ...
                            <div class="row add_row_up" style="display:none">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            ...
                            <button type="button" id="update" name="update" class="btn btn-primary mr-3 px-5"
