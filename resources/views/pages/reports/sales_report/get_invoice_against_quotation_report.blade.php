...
<body>
    ...
    <h4 style="text-align:center;">Invoice Against Quotation {{$FilterDate}}</h4>
    @foreach($staff as $stf)
    @if (sizeof($stf->invoice_list))
    <?php $i = 1; ?>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        ...
        <tr>
            ...
            <td style="text-align:left;width:20%;">{{session('short_code')}}-{{str_pad($inv->invoice_no, 5, '0', STR_PAD_LEFT)}}/{{date('Y', strtotime($inv->bill_date))}}</td>
