                    ...
                    <form class="form" id="form">
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <textarea type="text" class="form-control" id="bankaddress" name="bankaddress"
                                    ...
                                    <fieldset>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input"
                                                name="default_bank_account" id="default_bank_account">
                            ...
                            <div class="table-responsive">
                                <table class="table bank-data-table wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#"
                                                    class="updateModal btn btn-icon rounded-circle glow btn-warning mr-1 mb-1"
                                                    data-toggle="modal" data-target="#updateModal"
                                                    data-bank_id="{{$val->id}}" data-bankname="{{$val->bankname}}"
                                                    data-branchname="{{$val->branchname}}"
                                                    data-accnumber="{{$val->accnumber}}"
                                                    data-ifsccode="{{$val->ifsccode}}"
                                                    data-bankaddress="{{$val->bankaddress}}"
                                                    data-company="{{$val->company}}"
                                                    data-default_bank_account="{{$val->default_bank_account}}"
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="badge badge-pill badge-light-success">{{$val->default_bank_account}}</span>
                                                @else
                                                <span
                                                    class="badge badge-pill badge-light-danger">{{$val->default_bank_account}}</span>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                    ...
                    <form action="" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="hidden" class="form-control bank_id" id="bank_id" name="bank_id"
                                            value="">
                                        <input type="text" class="form-control bankname" id="bankname" name="bankname"
                                            placeholder="Bank Name">
                                        <label for="bankname">Bank Name</label>
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control branchname" id="branchname"
                                            name="branchname" placeholder="Bank Branch">
                                        <label for="branchname">Branch</label>
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control ifsccode" id="ifsccode" name="ifsccode"
                                            placeholder="IFSC Code">
                                        <label for="ifsccode">IFSC Code</label>
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <textarea type="text" class="form-control bankaddress" id="bankaddress"
                                            name="bankaddress" placeholder="Bank address"></textarea>
                                        <label for="bankaddress">Address</label>
                                ...
                                <div class="col-4">
                                    <fieldset>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input default_bank_account"
                                                name="default_bank_account" id="default_bank_account1">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (res.status == 'success') {
                        ...
                        var dataListView = $(".bank-data-table").DataTable({
                            columnDefs: [{
                                    targets: 0,
                                    className: "control",
                                },
