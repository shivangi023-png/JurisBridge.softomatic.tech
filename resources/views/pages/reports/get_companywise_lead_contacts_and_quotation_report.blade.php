...
<body>
    ...
    <h4 style="text-align:center;">Company-wise Lead Contacts and Quotation Report</h4>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <th style="background-color:#39498b; color:#fff;text-align:center;width:15%;" scope="col">Quotation</th>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left; width:15%;">{{ $row->total_quotations }}</td>
        </tr>
        @endforeach
    </table>
    @endif
