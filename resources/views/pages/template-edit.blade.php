                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <input type="hidden" name="" id="template_id" value="{{$val->id}}">
                                        <input type="text" class="form-control" id="template_name" name="template_name"
                                            placeholder="Template Name" value="{{$val->template_name}}">
                                ...
                                <!-- <div class="col-12 mb-5">
                                    <h5>Subject</h5>
                                    <input type="hidden" name="" id="subject" value="{{$val->subject}}">
                                ...
                                <div class="col-12">
                                    <h5>Subject</h5>
                                    <div class="form-label-group">
                                        <textarea class="form-control subject_editor" name="subject" autocomplete="off"
                                            value="{{$val->subject}}">{{$val->subject}}</textarea>
                                    </div>
                                    <span class="subject_editor_err valid_err"></span>
                                </div>
                                <div class="col-12 mb-3">
                                    <h5>Body</h5>
                                    <input type="hidden" name="" id="body" value="{{$val->message}}">
                                    <div class="full-editor">
                                        <div class="row">
                                            <div class="col-12">
...
$(document).ready(function() {
    ...
    $('#full-container1 .body_editor').html(body);
