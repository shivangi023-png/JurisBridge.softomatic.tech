                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" class="form-control staff_name" id="staff_name"
                                            name="staff_name" placeholder="Staff Name" value="{{$val->name}}">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="email" class="form-control emailid" id="emailid" name="emailid"
                                            placeholder="Email" value="{{$val->emailid}}">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control mobile" id="mobile" name="mobile"
                                            placeholder="Mobile" value="{{$val->mobile}}">
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control designation" id="designation"
                                            name="designation" placeholder="Department" value="{{$val->designation}}">
                                        ...
                                        <fieldset class="form-group">
                                            <div class="input-group">
                                                <select name="role_id" id="role_id" class="form-control role_id">
                                                    ...
                                                    @foreach($role as $rl)
                                                    <option value="{{$rl->id}}"
                                                        {{$val->role_id==$rl->id ? 'selected':''}}>{{$rl->role}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <fieldset class="form-group">
                                            <div class="input-group">
                                                <select name="company[]" id="company" class="form-control company"
                                                    ...
                                                    <option value="{{$com->id}}"
                                                        {{ (in_array($com->id,$val->company_id)) ? 'selected' : '' }}>
                                                        {{$com->company_name}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="col-3">
                                    <div class="form-label-group">
                                        <textarea class="form-control address" id="address" name="address"
                                            ...
                                            value="{{$val->address}}">{{$val->address}}</textarea>
                                ...
                                <div class="col-md-3 img_link_div">
                                    <a href="{{$val->image}}" id="a_link" target="_blank">{{$val->image}}</a><span><i
                                ...
                                <div class="col-md-3 sg_link_div">
                                    <a href="{{$val->signature}}" id="a_link"
                                        target="_blank">{{$val->signature}}</a><span><i class="bx bxs-pencil"
                                            id="edit_sign"></i></span>
