<div class="card">
             ...
             <li class="d-flex align-items-center mr-1">
                 ...
                 <div class="dropdown">
                     <div class="dropdown-toggle" role="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         <span class="next_followup-text">Today</span>
                     </div>
                     <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                         <a class="dropdown-item" href="javascript:;" data-value="today_followup" data-display="Today" onclick="filter_today_nextfollowup('today_followup','Today')">Today</a>
                         <a class="dropdown-item" data-display="This Week" href="javascript:;" data-value="weekly_followup" onclick="filter_today_nextfollowup('weekly_followup','This Week')">This Week</a>
                     </div>
                 </div>
             </li>
     ...
     <div class="card-body next_followup_div">
         <div class="table-responsive">
             <table class="table next_followup_datatable">
                 <thead>
                     <th>S.No.</th>
                     <th>Contact To</th>
                     <th>Contact By</th>
 ...
 <script>
     $(".next_followup_datatable").DataTable({
         ordering: false,
         lengthChange: false,
         bFilter: false,
         searching: false,
