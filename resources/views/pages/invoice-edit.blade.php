            ...
            <div class="col-xl-9 col-md-8 col-12">
                <div class="card">
                    ...
                    <div class="card-header mt-2">
                       <h4 class="card-title">Tax Invoice Edit</h4>
                    </div>
                ...
                <div class="row">
                   ...
                   <input type="hidden" value="tax" class="invoice_type">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-auto mr-auto">
                        <a href="invoice_list" class="btn btn-icon btn-warning px-5 mr1 mb-1">Go Back</a>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-xl-3 col-md-4 col-12">
        <div class="card invoice-action-wrapper shadow-none border">
            <div class="card-body">
                ...
                <div class="invoice-action-btn mb-1">
                    <a href="download_invoice-{{$row->id}}-tax" class="btn btn-light-primary btn-block">Download Invoice</a>
                </div>
                <div class="invoice-action-btn mb-1">
                    <a href="generate_invoice-{{$row->id}}-tax" class="btn btn-light-primary btn-block">Preview</a>
                </div>
                <div class="invoice-action-btn mb-1">
                    <button type="button" class="btn btn-light-primary btn-block update">Update</button>
                </div>
                <div class="invoice-action-btn mb-1">
                    <button type="button" class="btn btn-success btn-block" id="add_payment_btn">
        ...
        <div class="payment_div" style="display:none">
            ...
            <div class="my-2" id="ref_div" style="display:none">
                <div class="col-xl-12 col-md-12 col-12">
                    <fieldset class="form-label-group">
            ...
            <div class="my-2" id="cheque_div" style="display:none">
                <div class="col-xl-12 col-md-12 col-12">
                    <fieldset class="form-label-group">
            ...
            <div class="my-2" id="bank_div" style="display:none">
                <div class="col-xl-12 col-md-12 col-12">
                    <fieldset class="form-label-group">
            ...
            <div class="my-2">
                <div class="col-xl-12 col-md-12 col-12">
                    <fieldset class="form-label-group">
                        <input type="text" class="form-control payment" value="{{$row->paid_amount}}" id="payment" placeholder="Payment" readonly>
            ...
            <div class="my-2">
                <div class="col-xl-12 col-md-12 col-12">
                    <input type="hidden" name="company" class="company_id" value="{{$row->company}}" id="company_id">
                </div>
            </div>
            @if($row->tds_applicable=='yes')
            <div class="my-2">
                <div class="col-xl-12 col-md-12 col-12">
            ...
            <div class="my-2">
                ...
                <div class="col-xl-12 col-md-12 col-12">
                    ...
                    <button type="button" class="btn btn-light-primary mr-1 mb-1" id="submit_payment_btn">Save</button>
                    <button type="button" class="btn btn-light-danger mr-1 mb-1" id="cancel_payment_btn">Cancel</button>
