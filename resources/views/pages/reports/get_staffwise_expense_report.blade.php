...
<body>
    ...
    <h4 style="text-align:center;">Staffwise Expense Report {{$FilterDate}}</h4>
    <h4 style="text-align:right;color:green;">Total Expense : {{AppHelper::moneyFormatIndia($total)}}</h4>
    @foreach ($staff as $stf)
    <?php $i = 1; ?>
    @if (sizeof($stf->expense_list))
    <?php $i = 1; ?>
    <h5 class="text-primary"><strong> Staff -{{$stf->name}}</strong></h5>
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        ...
        <tr>
            ...
            <td style="text-align:center;width:5%;">{{$row->self}}</td>
