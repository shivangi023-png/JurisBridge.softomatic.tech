...
<body>
    ...
    <h4 style="text-align:center;">Client Report With No Contact {{$FilterDate}}</h4>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <th style="background-color:#39498b; color:#fff;text-align:center;width:15%;" scope="col">Email</th>
