            ...
            <div class="data_div">
                ...
                <div class="action-dropdown-btn d-none">
                    <div class="dropdown client-filter-action">
                        <button class="btn border dropdown-toggle mr-1" type="button" id="client-filter-btn"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="client-filter-btn">
                            ...
                            <a href="#" class="dropdown-item active_btn" data-value="inactive">In Active</a>
                    ...
                    <div class="client-options">
                        <a href="client_add" class="btn btn-icon btn-outline-primary mr-1" role="button"
                            aria-pressed="true">
                    ...
                    <table class="table client-data-table wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="client-customer">{{ $row->case_no }}
