                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="hidden" class="form-control" id="company_id" name="company_id" value="{{$val->id}}">
                                        <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" value="{{$val->company_name}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="short_code" name="short_code" placeholder="Short Code" value="{{$val->short_code}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="pan_no" name="pan_no" placeholder="Pan Number" value="{{$val->pan_no}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="gst_no" name="gst_no" placeholder="GST Number" value="{{$val->gst_no}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="company_email" name="company_email" placeholder="Email" value="{{$val->company_email}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="company_contact" name="company_contact" placeholder="Contact" value="{{$val->company_contact}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="website_url" name="website_url" placeholder="Website Url" value="{{$val->website_url}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="facebook_url" name="facebook_url" placeholder="Facebook Url" value="{{$val->facebook_url}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="youtube_url" name="youtube_url" placeholder="Youtube Url" value="{{$val->youtube_url}}">
                                ...
                                <div class="col-4">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="head_office" name="head_office" placeholder="Head Office" value="{{$val->head_office}}">
                                ...
                                <div class="col-4 img_link_div">
                                    <a href="{{$val->company_logo}}" id="a_link" target="_blank">{{$val->company_logo}}</a><span><i class="bx bxs-pencil" id="edit_img"></i></span>
                                ...
                                <div class="col-2">
                                    <fieldset>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="tds_applicable" id="tds_applicable" {{ ($val->tds_applicable=="yes")? "checked" : "" }}>
                                ...
                                <div class="col-2">
                                    <fieldset>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" name="tax_applicable" id="tax_applicable" {{ ($val->tax_applicable=="yes")? "checked" : "" }}>
                                ...
                                <div class="col-12">
                                    <div class="form-label-group">
                                        <textarea type="text" class="form-control" id="company_address" name="company_address" placeholder="Address" value="{{$val->company_address}}">{{$val->company_address}}</textarea>
                            ...
                            <div class="row main_row">
                                <div class="col-3">
                                    <div class="form-label-group">
                                        ...
                                        <input type="text" class="form-control company_branch my-2" id="company_branch" name="company_branch[]" placeholder="Branch Name" value="{{$branch}}">
                                        <label for="company_branch">Company Branch</label>
                                        <span class="company_branch_err valid_err"></span>
                                        @endforeach
                                        @else
                                        <input type="text" class="form-control company_branch my-2" id="company_branch" name="company_branch[]" placeholder="Branch Name" value="">
                                        <label for="company_branch">Company Branch</label>
                                        <span class="company_branch_err valid_err"></span>
                                        @endif
                                    </div>
