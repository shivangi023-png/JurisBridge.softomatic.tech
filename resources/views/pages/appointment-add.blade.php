                    ...
                    <form method="POST" action='' id="form">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <fieldset class="d-flex ">
                                            <input type="text" class="form-control pickadate mr-2 meeting_date"
                            ...
                            <div class="col-12 col-md-4">
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control meeting_place" id="meeting_place"
                                            name="meeting_place">
                        ...
                        <div class="row">
                            <div class="col-auto mr-auto">
                                <a href="appointment-list" class="btn btn-icon btn-warning px-5 mr1 mb-1">Go Back</a>
                            </div>
                            <div class="col-auto">
                                <button type="button" name="submit" class="btn btn-primary px-5 mr-3 submit"
