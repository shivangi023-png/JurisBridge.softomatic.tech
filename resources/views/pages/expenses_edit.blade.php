        ...
        <div class="col-xl-9 col-md-8 col-12">
            ...
            <div class="card">
                <div class="card-body pb-0 mx-25">
                    ...
                    <form method="" action='' id="update_expense_form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @foreach($expenses as $row)
                        <div class="row mx-0 expense-info">
                            <div class="col-xl-6 col-md-12 d-flex align-items-center pl-0">
                                <h5 class="expense-number mb-0 mr-75">Update Expenses</h6>
                                    <input type="hidden" class="expense_id" name="expense_id" value="{{$row->id}}">
                            </div>
                            <div class="col-xl-6 col-md-12 px-0 pt-xl-0 pt-1">
                                <div
                                    class="expense-date-picker d-flex align-items-center justify-content-xl-end flex-wrap ">
                                    <div class="d-flex align-items-center">
                                        <fieldset class="d-flex" name="date">
                                            <input type="text" class="form-control date pickadate mr-2 mb-50 mb-sm-0"
                                                name="date" id="floating-label1" placeholder="Date"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control client" id="client" name="client">
                                            ...
                                            <option value="{{$client->id}}" selected>{{$client->client_name}}
                                                @if($client->case_no!="") <span
                                                    class="subtitle">({{$client->case_no}})</span>@endif</option>
                                            @else
                                            <option value=""></option>
                                ...
                                <fieldset class="form-group">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control ledger" id="ledger" name="ledger">
                                            ...
                                            @if($head->subhead_id==$row->ledger)
                                            <option value="{{$head->subhead_id}}" selected>{{$head->sub_heads}}</option>
                                            @else
                        ...
                        <div class="row expense-info" id="subhead_add">
                            ...
                            <div class="col-md-5 col-12">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control subhead" id="subhead"
                                            placeholder="Subhead" name="subhead">
                            ...
                            <div class="col-md-1 col-12">
                                <button class="btn btn-light-success btn-sm" data-repeater-create type="button"
                                    id="ledgersubmit">
                                    Save
                                </button>
                            </div>
                            <div class="col-md-1 col-12">
                                <button class="btn btn-light-danger btn-sm" data-repeater-create type="button"
                                    id="ledgerdelete">
                        ...
                        <div class="row mode_of_payment">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="d-inline-block mr-2 mb-1">
                                        <fieldset>
                                            ...
                                            <div class="radio radio-shadow">
                                                <input type="radio" class="form-control mode_of_payment"
                                                    id="radioshadow1" name="mode_of_payment" value="cash"
                                                    {{ ($row->mode_of_payment=="cash")? "checked" : "" }}>
                                    ...
                                    <li class="d-inline-block mr-2 mb-1">
                                        <fieldset>
                                            <div class="radio radio-shadow">
                                                <input type="radio" class="form-control mode_of_payment"
                                                    id="radioshadow2" name="mode_of_payment" value="cheque"
                                                    {{ ($row->mode_of_payment=="cheque")? "checked" : "" }}>
                                    ...
                                    <li class="d-inline-block mr-2 mb-1">
                                        <fieldset>
                                            <div class="radio radio-shadow">
                                                <input type="radio" class="form-control mode_of_payment"
                                                    id="radioshadow3" name="mode_of_payment" value="online"
                                                    {{ ($row->mode_of_payment=="online")? "checked" : "" }}>
                            ...
                            <div class="col-md-2 col-12">
                                <div class="form-label-group">
                                    <fieldset>
                                        <div class="checkbox">
                                            <input type="checkbox" class="checkbox-input reimburse" id="checkbox1"
                                                value="yes" name="reimburse" {{ ($row->self=='yes')? 'checked' : '' }}>
                        ...
                        <div class="row expense-info" id="amt_ref_div">
                            <div class="col-md-4 col-12" id="amountdiv">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control amount" id="floating-label1"
                                            placeholder="Amount" name="amount" value="{{$row->amount}}">
                            ...
                            @if($row->mode_of_payment=="online")
                             <div class="col-md-4 col-12" id="referencediv">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control ref_no" id="ref_no"
                                            placeholder="Reference no." name="ref_no" value="{{$row->ref_no}}">
                            ...
                            @else
                            <div class="col-md-4 col-12" id="referencediv" style="display:none">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control ref_no" id="ref_no"
                                            placeholder="Reference no." name="ref_no" >
                                        <span class="valid_err ref_no_err"></span>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12" id="cheque_div">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control chq_no" id="chq_no"
                                            placeholder="cheque no." name="chq_no" value="{{$row->cheque_no}}">
                                        <span class="valid_err chq_no_err"></span>
                                    </fieldset>
                                </div>
                            </div>
                            @else
                             <div class="col-md-4 col-12" id="cheque_div" style="display:none">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control chq_no" id="chq_no"
                                            placeholder="cheque no." name="chq_no" >
                                        <span class="valid_err chq_no_err"></span>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            @endif
                            @if($row->mode_of_payment=="online" || $row->mode_of_payment=="cheque")
                            <div class="col-md-4 col-12" id="bankdiv">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control bank_name" id="bank_name"
                                            placeholder="Bank Name" name="bank_name" value="{{$row->bank_name}}">
                                        <span class="valid_err bank_name_err"></span>
                                    </fieldset>
                                </div>
                            </div>
                            @else
                            <div class="col-md-4 col-12" id="bankdiv" style="display:none">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        <input type="text" class="form-control bank_name" id="bank_name"
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                    <fieldset class="form-group">
                                        ...
                                        <textarea class="form-control remarks" id="remarks" rows="3"
                                            placeholder="Remarks" name="remarks"
                                            value="{{$row->remarks}}">{{$row->remarks}}</textarea>
                        ...
                        <div class="row expense-info">
                            @if($row->bill!='')
                            <div class="col-12 inv_link_div mb-2">
                                <a href="{{$row->bill}}" id="a_link" target="_blank">{{$row->bill}}</a><span><i
                                        class="bx bxs-pencil" id="edit_img"></i></span>

                            </div>
                            <div class="col-10 inv_file_div" style="display:none">
                                <div class="form-label-group">
                            ...
                            <div class="col-2 inv_file_div" style="display:none">
                        ...
                        <div class="row">
                            <div class="col-auto mr-auto">
                                <a href="expense_list" class="btn btn-icon btn-warning mr-1 mb-1 px-5">Go Back</a>
                            </div>
                            <div class="col-auto">
                                <button type="button" name="submit"
                                    class="btn btn-primary mr-3 px-5 update">Update</button>
            ...
            <div class="card expense-action-wrapper shadow-none border">
                <div class="card-body">
                    ...
                    <div class="expense-action-btn mb-1">
                        <a href="download_invoice-{{$row->id}}" id="download_expense"
                            class="btn btn-light-primary btn-block">
                            <span>Download Expenses</span>
                        </a>
                    </div>
                    <div class="expense-action-btn mb-1">
                        <a href="generate_invoice-{{$row->id}}" id="preview"
                            class="btn btn-light-primary btn-block">Preview</a>
                    </div>
                    <div class="expense-action-btn mb-1">
                        <button type="button" class="btn btn-light-primary btn-block update"
...
$(document).ready(function() {
    ...
    $(document).on('click', '.update', function() {
        ...
        var form = $('#update_expense_form')[0];
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (res.status == 'success') {
                        ...
                        $("#update_expense_form").trigger('reset');
                        $('#bankdiv').hide();
                        $('#referencediv').hide();
                        $('#cheque_div').hide();
