...
<ul class="nav nav-tabs" role="tablist" style=" margin-bottom: -20px !important;">
    <li class="nav-item">
        ...
        <a class="nav-link active" href="my_task" aria-controls="my_task" role="tab" aria-selected="true">
            
            <span class="align-middle">Table View</span>
        </a>
        @else
        <a class="nav-link" href="my_task" aria-controls="my_task" role="tab" aria-selected="true">
    ...
    <li class="nav-item">
        @if ('my_task_grid'== Request::path())
        <a class="nav-link active" href="my_task_grid" aria-controls="task" role="tab" aria-selected="true">
            
            <span class="align-middle">Grid View</span>
        </a>
        @else
        <a class="nav-link" href="my_task_grid" aria-controls="task" role="tab" aria-selected="true">
